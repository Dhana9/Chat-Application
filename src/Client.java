...
public class Client extends JFrame implements ActionListener {
    ...
    public Client() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Icons/Picture2.png"));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true) {
                ...
                JPanel label = formatLabel(msg);

                JPanel left = new JPanel(new BorderLayout());
                left.add(label, BorderLayout.LINE_START);
